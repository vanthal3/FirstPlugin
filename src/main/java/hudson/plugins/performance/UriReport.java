...
public class UriReport extends AbstractReport implements Serializable, ModelObject,
  ...
  UriReport(String staplerUri, String uri, Integer myid) {
  ...
  private Map<Integer, Map<Integer, HttpSample>> httpSampleMap=new HashMap<Integer, Map<Integer, HttpSample>>();
 ...
 // public static Map<Integer, HttpSample> httpSampleMap = new

  public void setHttpSample(HttpSample hs){
    this.httpSample=hs;
...
//    System.out.println("my code from old is: "+ getHttpSample().getHttpCode());
//    System.out.println("my code new is: "+ getNewHttpSample().getHttpCode());
//    //System.out.println("my code new w/o get method is: "+ newHttpSample.getHttpCode());
//
...
//    System.out.println("my age is: "+myAge);
//    System.out.println("I have recived httpcode: ======================="+ httpSample.getHttpCode());
  ...
  public String getUri() {
    ...
    //System.out.println("in urireport: "+myAge);
    return uri;
  }
  ...
  public java.lang.Integer getUriID() {
    return uriID;
  }
